name: github-push
description: This skill should be used when the user wants to commit or push their current project to GitHub. It automates the command generation using the folder name as the repository name.
---
